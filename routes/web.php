...
Route::get('/admin/puka-creations/admin-login', 'Auth\AuthController@getLogin')->name('admin');
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Customer route start
           ...
           //Blog Start
            ...
            'uses' => 'BlogController@drop']);//Record Comment Store
...
Route::post('pay-later', 'Frontend\CheckoutController@pay_later')->name('pay-later');
