...
class Product extends Model
{
    ...
    protected $fillable = [
       'sku', 'quantity', 'thumbnail', 'closeout', 'trending', 'offer_price', 'four_lavel', 'featured_product', 'regular_price', 'five_lavel', 'six_lavel', 'seven_lavel', 'category_id', 'sub_category', 'sub_sub_category', 'product_description', 'name', 'description', 'url', 'featured_image', 'meta_title', 'meta_description', 'srp', 'status', 'created_at', 'updated_at', 'deleted_at', 'created_by', 'updated_by', 'deleted_by'
    ];
