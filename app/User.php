...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'user_type', 'first_name', 'last_name', 'name', 'mobile', 'email', 'premium', 'gender', 'mobile', 'unique_id' ,'password', 'profile_image', 'provider', 'status', 'api_key', 'access_token', 'created_at', 'updated_at', 'deleted_at', 'created_by', 'deleted_by', 'updated_by'
    ];
