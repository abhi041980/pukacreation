...
try {
    ...
    // dd($category);
     ...
     // dd($products);
      ...
      $counts = Product::select('name')->where('category_id', $category->id)->orwhere('sub_category', $category->id)->orwhere('sub_sub_category', $category->id)->orwhere('four_lavel', $category->id)->orwhere('five_lavel', $category->id)->orwhere('six_lavel', $category->id)->orwhere('seven_lavel', $category->id)->where('status', 1)->count();
  ...
  public function getSort(Request $request){
    try{
      ...
      if($request->sort_by == 1){
        ...
        if($request->category_id == 78787){
          $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
          ->where('status', 1)->where('trending', 1)->orderBy('id', 'DESC')->get();
        } else {
          $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
          ->where('status', 1)->where('category_id', $request->category_id)->Orwhere('sub_category', $request->category_id)->orderBy('id', 'DESC')->paginate(100);
        }
      }
      ...
      if($request->sort_by == 2){
        ...
        if($request->category_id == 78787){
        $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
        ->where('status', 1)->where('trending', 1)->orderBy('offer_price', 'DESC')->get();
        } else {
        $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
        ->where('status', 1)->where('category_id', $request->category_id)->Orwhere('sub_category', $request->category_id)->orderBy('offer_price', 'DESC')->paginate(100);
        }
      }
      ...
      if($request->sort_by == 3){
        ...
        if($request->category_id == 78787){
          $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
          ->where('status', 1)->where('trending', 1)->orderBy('offer_price', 'ASC')->get();
        } else {
          $products = Product::select('thumbnail', 'name', 'id', 'url', 'offer_price', 'regular_price')
          ->where('status', 1)->where('category_id', $request->category_id)->Orwhere('sub_category', $request->category_id)->orderBy('offer_price', 'ASC')->paginate(100);
        }
      }
