...
class OrderController extends  Controller{
    ...
    public function edit($id = null) {
        ...
        ->select('order_products.*', 'products.name', 'products.thumbnail', 'products.sku')
        ->where('order_products.order_id', $result->id)
        ->get();
        $country = \DB::table('countries')->select('country_name')->where('id', $shipping->country)->first();
        ...
        return view('admin.order.create', compact('result','user_name','shipping','offer','OrderProduct', 'id', 'statusType', 'orderStatus', 'country'));
