...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top: 20px;">
                                        <div class="form-group"> 
                                        <label>Premium</label>
                                            <select name="premium" class="select2 form-control1" required="true">
                                                <option value="">-Select-</option>
                                                @if(isset($result))
                                                <option @if($result->premium==1) selected @endif value="1">Active</option>
                                                <option @if($result->premium==0) selected @endif} value="0">Inactive</option>
                                                @else
                                                <option {{ old('premium') == '1' ? 'selected' : '' }} value="1">Active</option>
                                                <option {{ old('premium') == '0' ? 'selected' : '' }} value="0">Inactive</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
            ...
            @if($i == 0)
            <p>Kindly add a shipping address</p>
            @endif
                            </div>
                        </div>
                    </div>
