                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mgn20">
                                        ...
                                        {!! Form::number('total_payment', null, array('class' => 'form-control', 'required' => 'true')) !!}
                                    ...
                                    <div class="col-md-4 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            {!! Form::number('down_payment_1', null, array('class' => 'form-control')) !!}
                                    ...
                                    <div class="col-md-4 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            {!! Form::number('down_payment_2', null, array('class' => 'form-control')) !!}
                                    ...
                                    <div class="col-md-4 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            {!! Form::number('down_payment_3', null, array('class' => 'form-control')) !!}
                                    ...
                                    <div class="col-md-4 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            <input type="number" value="{{ $result->down_payment_3 + $result->down_payment_2 + $result->down_payment_1 }}" class="form-control" readonly>
                                    ...
                                    <div class="col-md-4 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            <input type="number" value="{{ $result->total_payment - ($result->down_payment_3 + $result->down_payment_2 + $result->down_payment_1) }}" 
                                   ...
                                   <!-- <div class="col-md-6 mgn20">
                                         <div class="form-group"> 
                                            ...
                                            {!! Form::number('total_cost', null, array('class' => 'form-control')) !!}
