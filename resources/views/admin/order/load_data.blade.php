...
<tr id="order_{{ $detail->id }}">
    ...
    <td class="noPrint" style="text-align: center;"><a href="#" data-toggle="modal" data-target="#exampleModal{{ $detail->id }}" style="background: #be0027; color: #fff; padding: 6px 15px; border-radius: 14px;"> {!! $detail->current_status !!}</a>
...
<div class="a-fixed-right-grid-col a-col-left" style="padding-right:0%;float:left; width: 650px;">
<div class="a-row">
