...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header" style="font-size: 22px;font-weight: 500;">Max Sale Product Wise</h1>
...
<tr>
    ...
    <td style="border-right: 1px solid #DDDDDD;text-align: center;">{{ get_pro_max_order($OrderProduct->product_id) }}</td>
    <td style="border-right: 1px solid #DDDDDD;text-align: center;">{{ $OrderProduct->max_qty }}</td>
    <td style="border-right: 1px solid #DDDDDD;">{{ $pro->category }}</td>
