    ...
    <div style="float: left; width: 100%; padding: 0px 15px 15px 15px; min-height: 300px; border: 1px solid #004c69;">
      ...
      <div style="float: left; width: 100%; height: 100%; border-bottom: 1px solid #004c69; margin: 15px auto 0px auto;">
        <div style="float: left; width: 49%;">
          ...
          <p style="float: left; color: #000; margin: 10px 0px; font-size: 14px; margin-top: -1px;">Puka Creations</p>
          <p style="float: left; width:100%; color: #000; margin: 0px 0px 10px 0px; font-size: 14px;">16840 South Main St<br> Gardena CA 90248-3122<br> U.S.A</p>
        </div>
        <div style="float: right; text-align: right; width: 48%;">
          ...
          <p style="float: right; color: #000; margin: 10px 0px 10px 0px; font-size: 14px;"> {{$shipping_add->name}}<br> {{$shipping_add->address}}, {{$shipping_add->city}},  {{ $shipping_add->state }}, {{$shipping_add->pincode}}<br> Phone: {{$shipping_add->mobile}}</p>
        </div>
      </div>
        ...
        <table style="width: 100%; border-spacing: 0px; text-align: center;">
          <thead>
                 <tr style="margin:0px; padding: 0px;">
                    ...
                    <th style="border-bottom: 1px solid #000; border-right: 1px solid #000;">Total Amount</th>
                  </tr>
          </thead>
          <tbody>
            @php $i = 0; 
            ...
            @endphp 
                  ...
                  <tr>
                    ...
                    <td style="border-bottom: 1px solid #000; border-right: 1px solid #000;">&#36;{{ $o_pro->price*$o_pro->quantity }}</td>
                  </tr>  
            @endforeach
            ...
            <tr>
                ...
                <td colspan="2" style="border-right: 1px solid #000;border-bottom: 1px solid #000; background: #CACACA;">&#36;{{$current_order->total_price}}</td>
            </tr>
                  ...
                  <tr>
                    <td colspan="6" style="text-align: center; font-weight: bold; border-top: 1px solid #000;">
                      <p style="font-size: 14px; color: #ab7d47; margin:0px; padding: 0px;">For any query mail us at
                        <span style="font-weight:bold;">sezer@pukacreations.com</span>
                      </p>
                    </td>
                  </tr>
