      ...
      <tbody>
        <tr>
          <td style=" font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
            ...
            ">
            <img src="http://uphaar.thegirafe.com/assets/frontend/images/logo.png" class="carpool_logo" width="300" style="  display: block;
              margin: 0 auto;
              margin: 30px auto;">
          </td>
        </tr>
                ...
                <tr>
                  <td class="section_content_padded" style="  font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
                    ...
                    <h1 style=" font-size: 20px;
                      ...
                      margin-bottom: 0;
                      ">Hi Admin,</h1>
                    <p class="near_title last" style="margin-top: 10px;margin-bottom: 0;">New User registerd in Uphaar.<br>
                      Name = <b>{{ $name }}</b><br>
                      Email = <b>{{ $email }}</b></p>
        ...
        <tr>
          <td style=" font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
            ...
            <p class="footer_legal" style=" padding: 20px 0 40px;
              ...
              line-height: 1.5;
              ">
              All Rights Reserved © Copyright 2019 Uphaar.
            </p>
          </td>
        </tr>
      </tbody>
