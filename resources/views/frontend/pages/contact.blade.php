      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <li class="alert alert-success" style="list-style: none; margin-top: 25px;">Your enquiry has been received and we will be contacting you shortly to follow-up.</li>
            @endif  
            ...
            <div class="col-md-7">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <textarea name="message" value="{{ old('message') }}" class="form-control" required="true" placeholder="Message"></textarea>
