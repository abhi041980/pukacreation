    ...
    <div class="container">  
            ...
            <div class="table-responsive">
              @if(count($wishlist_products) != 0) 
                    <table class="table table-bordered text-center mb-4">
                      <thead>
                        <tr class="text-uppercase" style="    background: #f3f3f3;">
                          <th>
        ...
        @if($count == 0)
         <div class="text-center" style="width: 100%;">
              <img src="{!! asset('assets/frontend/images/no_product_wis.jpg') !!}" class="img-fluid d-inline-block max-height-400" alt="" style="max-width: 55%;"> 
            </div>
        @endif
      </div>
    </section>
