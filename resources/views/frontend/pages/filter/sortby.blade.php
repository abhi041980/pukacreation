        <ul class="sort_filter">
          ...
          @if($category_id != 78787)
          <li class=" @if($sort_by == 4) active @endif"><button value="4" onclick="SortFilter(this.value)">Top Trending</button></li>
          @endif
          @else
             <li class=" @if($sort_by == 4) active @endif"><button value="4" onclick="SortFilter(this.value)">Top Trending</button></li>
          @endif
             <li class=" @if($sort_by == 3) active @endif"><button value="3" onclick="SortFilter(this.value)">Low Price to High</button></li>
              <li class=" @if($sort_by == 2) active @endif"><button value="2" onclick="SortFilter(this.value)">High Price to Low</button></li>
              <li class=" @if($sort_by == 1) active @endif"><button value="1" onclick="SortFilter(this.value)">New Arrivals</button></li>
               <li>Sort by:</li>
            </ul>
