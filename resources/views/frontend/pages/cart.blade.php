    ...
    <section class="cart-main">
      ...
      @if(count($cart_products) != 0) 
          ...
          if($offer_based == 'product'){
            ...
            @endphp
                        ...
                        <tr style="border-bottom: 1px solid #dee2e6;">
                          <td>
                              <a href="{{ route('productDetail', $cart_product->url)}}">
                                <img class="max-h-100" src="{!! asset($cart_product->thumbnail) !!}" alt=""></a>
                          </td>
                          <td> 
                           <h5><a href="{{ route('productDetail', $cart_product->url)}}">{{ $cart_product->name }}</a></h5>
                          </td>
                          <td class="second_td" style="text-align: center;">
                            
                            <p style="font-size: 12px;" id="widthout_sale_price{{ $cart_product->c_id }}"> @if($cd_price != 0) <del><i class="fa fa-dollar"></i><span">{{ $s_price }}</span></del> @endif </p>  
                              
                            <p><i class="fa fa-dollar"></i><span id="sale_price{{ $cart_product->c_id }}">{{ $s_price - $cd_price }}</span></p>
                          </td>
                          ...
                          <td class="third_td">
                           ...
                           <td class="second_td" style="text-align: center;">
                            ...
                            <p class="mb-0" style="font-size:12px;" id="without_2sale_price{{ $cart_product->c_id }}">@if($cd_price != 0) <del><i class="fa fa-dollar"></i><span>{{ $s_price*$cart_product->quantity }}</span></del>@endif</p>   
                               
                            <p class="mb-0"><i class="fa fa-dollar"></i><span id="2sale_price{{ $cart_product->c_id }}">{{ $s_price*$cart_product->quantity - $cd_price*$cart_product->quantity }}</span> </p>
        ...
        <!--     <div class="coupon-box">  
          ...
          <div class="col-md-3">
            ...
            <div class="total_c">
              ...
              <p style="font-size: 22px; font-weight: 600; color: #000; padding-top: 20px;">Total <span id="total_sale_price_cart1" style="color: #be0027;"> <i class="fa fa-dollar"></i>{{ $sale_price - $case_deal_price - $discount }}</span></p>
        ...
        <div class="text-center" style="width: 100%;">
              <img src="{!! asset('assets/frontend/images/empty_cart.jpg') !!}" class="img-fluid d-inline-block max-height-400" alt="" style="max-width: 55%;"> 
            </div>
        @endif
      </div>
    </section>
